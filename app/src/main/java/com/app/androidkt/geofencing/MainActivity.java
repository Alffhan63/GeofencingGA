...
//                    Toast.makeText(MainActivity.this,"Pos" + location.getLatitude() + "" + location.getLongitude(), Toast.LENGTH_SHORT).show();
//                    Log.d(TAG, "Location Change Lat Lng " + location.getLatitude() + " " + location.getLongitude());
    ...
    private Geofence getGeofence() {
        LatLng latLng = Constants.AREA_LANDMARKS.get(Constants.Posisi_Geofence);

        return new Geofence.Builder()
                .setRequestId(Constants.Posisi_Geofence)
...
//        Intent intent1 = new Intent(this, LocationMonitorService.class);
         ...
         Toast.makeText(MainActivity.this,"Anda Sudah Dekat Dengan Tujuan Anda", Toast.LENGTH_SHORT).show();
    ...
    private void stopGeoFencing() {
        ...
        stopService(new Intent(MainActivity.this, GeofenceRegistrationService.class));
        pendingIntent = getGeofencePendingIntent();
        ...
        invalidateOptionsMenu();
        GeofenceRegistrationService.v.cancel();
    }
...
//        GeofenceRegistrationService grs = new GeofenceRegistrationService();
